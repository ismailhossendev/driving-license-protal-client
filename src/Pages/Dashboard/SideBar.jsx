        ...
        <div className="hidden h-screen lg:flex flex-col justify-between border-r shadow-md shadow-slate-400 bg-white">
            <div className="px-4">
                ...
                <nav aria-label="Main Nav" className="mt-2 flex flex-col space-y-1">
                    <a href="#" className="flex items-center rounded-lg bg-gray-100 px-4 py-2 text-gray-700">
                    ...
                    <details className="group">
                        ...
                        <nav aria-label="Account Nav" className="mt-1.5 ml-8 flex flex-col">
                            ...
                            <form action="/logout">
                                <button type="submit" className="flex w-full items-center rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 opacity-75" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
                <a href="#" className="flex shrink-0 items-center bg-white p-4 hover:bg-gray-50">
